...
Cohesion: 0.08
Nodes (22): request, toRow(), request, toRow(), request, toRow(), request, toRow() (+14 more)

### Community 1 - "Translator.tsx"
Cohesion: 0.06
Nodes (87): isProviderId(), caretIn(), InsertMessage, dispatchInput(), replaceInContentEditable(), replaceInTextControl(), replaceSelection(), tryInsertText() (+79 more)

### Community 2 - "Popup.tsx"
Cohesion: 0.12
Nodes (18): HistoryRow(), relative, time(), CHIP_TONE, LanguageCard(), Meter(), RemovableChip(), SearchField() (+10 more)
...
Cohesion: 0.12
Nodes (32): RFC-7636, ApiError, call(), detect(), fixGrammar(), getSettings(), rewrite(), saveSettings() (+24 more)
...
### Community 8 - "history.ts"
Cohesion: 0.19
Nodes (10): History(), byDay(), Common, HISTORY_LIMIT, historyStore, item, pairLabel(), NOW (+2 more)
...
Cohesion: 0.06
Nodes (38): Busy, Error, FAVORITES, FieldIcon, FieldIconChecking, FieldIconClean, FieldIconError, FieldIconErrors (+30 more)
...
Cohesion: 0.11
Nodes (14): OptionsPage(), OptionsPageProps, Failed, Loading, meta, Saved, Saving, SignedIn (+6 more)
...
Cohesion: 0.18
Nodes (11): LANGUAGES, BrandMark(), fixed(), Flag(), Icon(), ICON_NAMES, Brand, Flags (+3 more)
...
Cohesion: 0.20
Nodes (15): ProviderId, PROVIDERS, isSiteDisabled(), parseSites(), Options(), activeTab(), App(), Notice (+7 more)
...
- **Why does `react` connect `buttons.tsx` to `ref_vitest`, `Translator.tsx`, `popup/main.tsx`, `Popup.tsx`, `extension/package.json`, `typography.stories.tsx`, `TranslatorWidget.tsx`, `icons.tsx`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `hono` connect `contract.ts` to `dev-gateway.ts`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `@storybook/react-vite` connect `icons.stories.tsx` to `Popup.tsx`, `Popup.stories.tsx`, `preview.tsx`, `extension/package.json`, `TranslatorWidget.stories.tsx`, `typography.stories.tsx`, `buttons.tsx`, `OptionsPage.stories.tsx`, `main.ts`?**
...
- **Should `Translator.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.06227645697454239 - nodes in this community are weakly interconnected._