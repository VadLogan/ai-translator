...
- `handle()` --calls--> `translate()`  [EXTRACTED]
  extension/src/entrypoints/background.ts → extension/src/api.ts
...
### Community 18 - "app.ts"
Cohesion: 0.08
Nodes (24): app, hits, port, callOpenAI(), client, createInput(), translate(), translate() (+16 more)
